...
public class SearchHomestayByName extends JFrame implements ActionListener {
	...
	public SearchHomestayByName(SearchHomestayMainMenu prevScreen, HomestaySystem homestaySys) {
		...
		p1.add(new JLabel("Please enter partial/full homestay's name"));
...
//			btnSearch.setEnabled(false);
			...
			for (Homestay homestay : homestaySys.getAllHomestay()) {
				if (homestay.getName().toLowerCase().contains(input)) {
...
//				 else
//				 text.append("Searching cannot found !");
			}
