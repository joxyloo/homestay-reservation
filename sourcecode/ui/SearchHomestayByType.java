...
public class SearchHomestayByType extends JFrame implements ActionListener {
	...
	public SearchHomestayByType(SearchHomestayMainMenu prevScreen, HomestaySystem homestaySys) {
		...
		p1.add(new JLabel("Please enter partial/full homestay's type"));
...
//			btnSearch.setEnabled(false);
			...
			for (Homestay homestay : homestaySys.getAllHomestay()) {
				if (homestay.getType().toLowerCase().contains(input)) {
